...
(function($) {
	...
	//
      ...
      $('.graduacao_slider_ul').each(function() {
        ...
        var count = slider.closest('.graduacao_slider').data('count');
        if (slidesToShow > count) {
          slidesToShow = count;
          if (slidesToShow < 1) {
            slidesToShow = 1;
    ...
    function slider_cursos() {
  
      var pager = function(el, i) {
        return '<a>' + i + '</a>';
      };
  
      $('.slider_cursos .content_slider_ul').each(function() {
  
          console.log("entrou uhu");
        if ( $(window).width() < 768 ) {
            var count = 1;
            dots: true;
            arrows: false;
    ...
    function slider_logo() {
      ...
      $('.slider_logo .content_slider_ul').each(function() {
    ...
    function slider_infra() {
  
      var pager = function(el, i) {
        return '<a>' + i + '</a>';
      };
  
      $('.slider_infra .content_slider_ul').each(function() {
    ...
    $('.outros_cursos_graduacao').each(function() {
 ...
                nextArrow: '.slider-next',
    ...
    function infiniteScrollPortfolio(){
      ...
      var $imgsrc = $('.imagem_produto img').attr('src');
      $('.conteudo_topo.topo_cursos').css('background-image', 'url(' + $imgsrc + ')');
