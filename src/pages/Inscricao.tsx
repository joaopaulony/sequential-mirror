...
const cursosGrad = ["Gestão de Recursos Humanos", "Biomedicina", "Pedagogia", "Farmácia", "Enfermagem"];
const formasIngresso = ["Vestibular Social", "Nota do ENEM", "Transferência", "Segunda Graduação", "Reopção de Curso"];
    ...
    <PageLayout>
      <section className="bg-primary py-16 text-primary-foreground">
        <div className="container">
          ...
          <p className="mt-4 text-lg text-primary-foreground/80">Faça sua inscrição na graduação</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container max-w-2xl">
          <div className="rounded-2xl border border-border bg-background p-8 shadow-sm">
            <h2 className="mb-6 text-2xl font-bold text-foreground">Graduação</h2>

            <div className="space-y-6">
              <div>
                <label className="mb-2 block text-sm font-medium text-foreground">Selecione o seu curso de interesse</label>
                <select
                  value={curso}
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-foreground">Forma de Ingresso</label>
                <select
                  value={forma}
                  onChange={(e) => setForma(e.target.value)}
                  className="w-full rounded-lg border border-border bg-background px-4 py-3 text-foreground"
                >
                  <option value="">Escolher forma de ingresso</option>
